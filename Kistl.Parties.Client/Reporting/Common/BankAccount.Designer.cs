...
#line 24 "P:\Kistl.Parties\Kistl.Parties.Client\Reporting\Common\BankAccount.cst"
this.WriteObjects("\\linebreak\r\n");
this.WriteObjects("BIC: \\tab ",  Format(account.BIC) , "\r\n");
this.WriteObjects("\\linebreak\r\n");
this.WriteObjects("IBAN: \\tab ",  Format(account.IBAN) , "\r\n");
#line 28 "P:\Kistl.Parties\Kistl.Parties.Client\Reporting\Common\BankAccount.cst"
} 
if(!string.IsNullOrEmpty(account.BankCodeNumber) && !string.IsNullOrEmpty(account.AccountNumber)) { 
#line 30 "P:\Kistl.Parties\Kistl.Parties.Client\Reporting\Common\BankAccount.cst"
this.WriteObjects("\\linebreak\r\n");
...
this.WriteObjects("}\r\n");
#line 36 "P:\Kistl.Parties\Kistl.Parties.Client\Reporting\Common\BankAccount.cst"
} 

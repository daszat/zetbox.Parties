...
this.WriteObjects("      ParagraphFormat {\r\n");
this.WriteObjects("        SpaceBefore = 0\r\n");
this.WriteObjects("        SpaceAfter = 0\r\n");
this.WriteObjects("      }\r\n");
this.WriteObjects("    }\r\n");
this.WriteObjects("\r\n");
...
this.WriteObjects("      Font { Size = 14 }\r\n");
this.WriteObjects("      ParagraphFormat {\r\n");
this.WriteObjects("        SpaceBefore = 6\r\n");
...
this.WriteObjects("      Font { Size = 12 Italic = true }\r\n");
this.WriteObjects("      ParagraphFormat {\r\n");
this.WriteObjects("        SpaceAfter = 3\r\n");
...
this.WriteObjects("      Font { Size = 12 }\r\n");
this.WriteObjects("      ParagraphFormat {\r\n");

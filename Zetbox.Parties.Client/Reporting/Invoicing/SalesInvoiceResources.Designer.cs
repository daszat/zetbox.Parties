...
namespace Zetbox.Parties.Client.Reporting.Invoicing {
    ...
    internal class SalesInvoiceResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Reversal {0}.
        /// </summary>
        internal static string SubjectReversal {
            get {
                return ResourceManager.GetString("SubjectReversal", resourceCulture);
            }
        }
